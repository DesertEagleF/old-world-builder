    ...
    <>
      ...
      <section className="column custom__column">
        <header className="editor__header">
          <div className="header-2">Game systems</div>
        </header>
        <ul>
      ...
      <section>
        <div className="header-2">Add a custom game system</div>
        <p>
          Template file:
          <a
      ...
      <section className="column custom__column">
        <header className="editor__header">
          <div className="header-2">Datasets</div>
        </header>
        <ul>
      ...
      <section>
        <div className="header-2">Add a custom dataset</div>
        <p>
          <a
            target="_blank"
            rel="noreferrer"
